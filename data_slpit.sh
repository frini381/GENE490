...
#############################################################################################
    ...
    file=paste0(dir,"/4584_4585_4586_20230417_GRCh37_split_ann_A0.01_HIGHMOD_DPGQ_out.tsv")
    ...
    write.table(data_Split_gnomAD, file=paste0(dir, "/4584_4585_4586_20230417_GRCh37_split_ann_A0.01_HIGHMOD_DPGQ_DS_out.tsv"), quote=FALSE, sep='\t', row.names=F) 
